...
*
*Не використовувався в початковій версії коду. В оновленій версії випадки, коли потрібно реалізовувати непотрібний абстрактний клас або віртуальний метод, трапляютсья вкрай рідко. Приклади класів, які
